...
# ВНИМАНИЕ: этот скрипт намеренно НЕ трогает trades-fallback-equities.json и
# trades-fallback-crypto.json. Их владелец — build_trades_fallback.js, который
# дописывает флаг Members-Signal на фиксированной позиции (крипто r[14],
# акции r[19]). Перегенерация этих файлов из «сырой» таблицы обрезает строки до
# 14 колонок и обнуляет точки участников в degraded-режиме — регрессия,
# закрытая тестом tests/fallback-dots.test.js.
